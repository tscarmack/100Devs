...
function canCharmanderBattle(currentTemperature){
    let celTemp = farToCel(currentTemperature)
if(celTemp > 0){
...
let enemyTrainersPokemon = ['big guy', 'pikachu', 'squirtle', 'another dude', 'biscuit']
for(let i =0; i < enemyTrainersPokemon.length; i++){
